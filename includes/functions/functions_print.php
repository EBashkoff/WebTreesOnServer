...
//  *************************************************************************************         
//  **********        
//  **********MY SITE EDIT:  ADD THE FOLLOWING 2 LINES TO GET LAST LOGGED IN TIME DISPLAYED IN "WHO IS ONLINE" LIST         
//	
//                        
                        $thetimestamp = get_user_setting($user_id, 'sessiontime');
			$content .= " (".format_timestamp($thetimestamp).' - '.WT_I18N::time_ago(WT_TIMESTAMP - $thetimestamp).")";
