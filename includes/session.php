...
//  *************************************************************************************         
//  **********        
//  **********MY SITE EDIT:  ADD one line below         
//
define('WT_WEBTREES_SITENAME', 'bashkoff-family.com');
...
//  *************************************************************************************
//  **********
//  **********MY SITE EDIT:  Comment out the following 5 lines to prevent a redirection loop when we are using https
//

//$SERVER_URL=WT_Site::preference('SERVER_URL');
//if ($SERVER_URL && $SERVER_URL != WT_SERVER_NAME.WT_SCRIPT_PATH) {die('$SERVER_URL' . $SERVER_URL . ' wtservername + script path:' . WT_SERVER_NAME.WT_SCRIPT_PATH);
...
//echo $id, WT_USER_ID, $WT_REQUEST->getClientIp(). '<br>';
...
//  *************************************************************************************         
//  **********        
//  **********MY SITE EDIT:  REPLACE         
//	header('Location: '.WT_SERVER_NAME.WT_SCRIPT_PATH);
//      WITH
        header('Location: ' . WT_SERVER_NAME . WT_SCRIPT_PATH . 'login.php?url=login.php');
	exit;
}
