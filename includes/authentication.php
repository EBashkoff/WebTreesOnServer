...
//  *************************************************************************************         
//  **********        
//  **********MY SITE EDIT:  REPLACE THE FOLLOWING LINE TO PERMIT LOGGING OF USERNAME ON LOGIN         
//                
//                AddToLog('Login successful', 'auth');
                
                AddToLog('Login successful by user ' . $user_name, 'auth');
...
//  *************************************************************************************         
//  **********        
//  **********MY SITE EDIT:  ADD THE FOLLOWING LINE TO UPDATE THE HTACCESS FILE IN THE gallery SUBDIRECTORY         
//
    require WT_ROOT . 'myHTACCESSUpdate.php';     // Update HTACCESS file in gallery subdirectory
}
